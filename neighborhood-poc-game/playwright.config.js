...
const baseURL = process.env.NEIGHBORHOOD_BASE_URL || 'http://127.0.0.1:4175';
const parsedBaseURL = new URL(baseURL);
const isLocalHost = ['127.0.0.1', 'localhost'].includes(parsedBaseURL.hostname);
const port = parsedBaseURL.port || '4175';
const disableWebServer = process.env.NEIGHBORHOOD_DISABLE_WEBSERVER === '1';
