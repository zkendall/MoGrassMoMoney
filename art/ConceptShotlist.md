...
6) **Lawn layout thumbnails**: 12 small yard “puzzle” designs increasing in complexity.

## UI concepts
7) **Day planning screen**: customer cards, forecast, HOA rules, equipment loadout.
8) **Customer card set**: 8 archetypes (budget, eco-friendly, “quiet hours,” perfectionist, huge estate, etc.).
9) **Upgrade shop grid**: equipment tiers with big icons and simple stat deltas.

## Regional establishing shots (one each)
10) PNW rainy yard + craftsman home
