...
REGION quick swaps:
- PNW: “Pacific Northwest, overcast, mist, fir trees, craftsman house, wet sidewalks”
- Rockies: “Rocky Mountains suburb, crisp sunlight, pine trees, mountain backdrop, strong shadows”
- New England: “New England, colonial house, stone wall, hydrangeas, fall foliage”
- Sunbelt: “Southwest/Sunbelt, stucco house, palm shadows, bright sun, pool blue accents, xeriscape edges”

## 4) Gameplay yard layout thumbnail sheet
“A sheet of 12 small top-down yard layout thumbnails for a lawn mowing game, increasing complexity, obstacles like sprinklers, flower beds, trees, fences, paths, readable shapes, [STYLE TOKENS], clean grid layout, no text”

## 5) UI mock (mood only)
“A cozy management game UI mockup for a lawn mowing business: day planning dashboard with customer cards, earnings summary, weather forecast, equipment loadout, friendly icon set, paper + modern app hybrid, [STYLE TOKENS], no brand names, no text that looks like a real product”
